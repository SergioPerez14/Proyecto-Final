                                    ...
                                    <div class="col-md-12">
                                        <form class="form-horizontal" role="form">
                                          <br>
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-2 control-label" for="example-email">F. de Nacimiento:</label>
                                                <div>
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" readonly="" value="" id="datepicker-autoclose">
                                                    </div><!-- input-group -->
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea class="form-control" rows="5" readonly="" value=""></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                              <center>
                                                ...
                                                <button type="submit" class="btn btn-danger btn-bordered">Eliminar usuario</button>
                                              </center>
                                            </div>
